...
<td class="esc">
	...
	<big><a href="#" class="btn btn-danger-light btn-sm" onclick="excluir('{$id}')" title="Excluir"><i class="fa fa-trash-can"></i></a></big>
		...
		<big><a class="btn btn-primary-light btn-sm " href="#" onclick="anamnese('{$cliente}', '{$nome_paciente}')" title="Editar Anamnese"><i class="fa fa-file "></i></a></big>

		<big><a class="btn btn-dark-light btn-sm " href="#" onclick="exames('{$cliente}', '{$nome_paciente}')" title="Solicitar Exames"><i class="fa fa-file-pdf-o"></i></a></big>
	
		<big><a class="btn btn-primary-light btn-sm " href="#" onclick="receita('{$cliente}', '{$nome_paciente}')" title="Gerar Receita"><i class="fa fa-stethoscope"></i></a></big>
