					...
					<div class="row">
						...
						<div class="col-md-2 mb-2 col-6">
							...
							<select name="acao" id="acao" class="form-select">								
								...
								<option value="extrair">Extraçao Indicada</option>
								<option value="cla1">Classe I</option>
								<option value="cla1_trat">Classe I - Realizado</option>
								<option value="cla2DO">Classe II DO</option>
								<option value="cla2DO_trat">Classe II DO - Realizado</option>
								<option value="cla2MO">Classe II MO</option>
								<option value="cla2MO_trat">Classe II MO - Realizado</option>
								<option value="cla2MOD">Classe II MOD</option>
								<option value="cla2MOD_trat">Classe II MOD - Realizado</option>
								<option value="cla3D">Classe III D</option>
								<option value="cla3D_trat">Classe III D - Realizado</option>
								<option value="cla3M">Classe III M</option>
								<option value="cla3M_trat">Classe III M - Realizado</option>
								<option value="cla3MD">Classe III MD</option>
								<option value="cla3MD_trat">Classe III MD - Realizado</option>
								<option value="cla4">Classe IV</option>
								<option value="cla4_trat">Classe IV - Realizado</option>
								<option value="cla5">Classe V</option>
								<option value="cla5_trat">Classe V - Realizado</option>
								<option value="canal">Endodontia</option>
								<option value="canal_trat">Endodontia - Realizado</option>
								<option value="protese">Prótese</option>
								<option value="protese_trat">Prótese - Realizado</option>

								<option value="implantes">Implante</option>
