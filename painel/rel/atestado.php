...
<div style="font-size: 15px;">
	<p style="margin-left:20px">Atesto para fins trabalhistas que o Sr(a) <b><?php echo $nome_paciente ?>
 ...
 <?php echo $motivo ?>.</p>
 <p style="margin-left:20px">Confirmo a validade do presente atestado, conforme o artigo 473 da CLT, a Lei nº 605/1949 e  
	Art. 159 do <p>Dec. nº 10.854/2021 da Legislação e Direitos do Trabalhador. 
	<p style="margin-left:20px">O paciente estará apto a voltar ao trabalho após o período de afastamento.</p>
</div>
<?php if($obs != ""){ ?>
