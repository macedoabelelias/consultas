	...
	<table id="" style="border-style: solid; font-size: 9px; margin-bottom:10px; width: 100%; table-layout: fixed; margin-top:0px;">
			<thead>
    			...
    			<tr >
					...
					<td style="width:15%; border-bottom: : 1px solid #000;"><b>TIPO SANGUÍNEO: </td>
					<td style="width:10%; border-bottom: : 1px solid #000; border-right: 1px solid #000;">
						<?php echo mb_strtoupper($tipo_sanguineo) ?>
					</td>
    			</tr>
    			<tr >
					<td style="width:10%;border-bottom: : 1px solid #000;"><b>PROFISSÃO </td>
					<td colspan="4" style="width:30%; border-right: : 1px solid #000; border-bottom: : 1px solid #000;">
